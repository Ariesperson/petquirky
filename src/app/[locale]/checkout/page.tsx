  ...
  return (
    <CheckoutClient
      ...
      labels={{
        ...
        returns: dict.footer.shipping_returns,
        ...
        checkoutAuthTitle: dict.checkout.auth_required_title,
        checkoutAuthBody: dict.checkout.auth_required_body,
        checkoutAuthLogin: dict.auth.login_submit,
        checkoutAuthRegister: dict.auth.register_submit,
